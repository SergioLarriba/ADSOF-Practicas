// En la entrega solo hay q poner el 3 y 4
...
public class SecuenciaPadovan {
    ...
    // Constructor de la clase, inicializa todas las variables del objeto 
    ...
    // Este metodo se utiliza cuando quieres imprimir con println, siempre devuelve un string como resultado, y lo que hace es mostrar el toString de secuencia, muestra la lista entre corchetes 
    @Override
